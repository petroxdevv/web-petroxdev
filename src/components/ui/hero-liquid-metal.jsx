...
const HeroLiquidMetalContext = React.createContext(undefined)
...
export const HeroLiquidMetalRoot = React.forwardRef(
  ({ className, children, srTitle = "AI SDK Agents", title = <span className="">
    ...
    const shaderOverrides = React.useMemo(() => {
      const overrides = {}
    ...
    const mergedMobileShaderProps = React.useMemo(() => ({
      ...
      ...mobileShaderProps,
      style: {
        ...(defaultMobileShaderProps.style),
        ...(mobileShaderProps?.style),
      },
      ...
      <div
        ...
        <MemoizedLiquidMetal
          ...
          image={
            ...
            (defaultDesktopShaderProps.image)
          } />
      </div>
    </div>
  );
...
export function HeroLiquidMetalMobileVisual({
  ...
  const resolvedMobileShaderProps = {
    ...
    ...mobileShaderProps,
    style: {
      ...(context.mergedMobileShaderProps.style),
      ...(mobileShaderProps?.style),
    },
  }
  ...
  return (
    <div
      ...
      {...props}>
      <div
        className="absolute inset-x-0 top-0 z-10 h-56 bg-gradient-to-b from-background via-background/95 to-transparent" />
      <MemoizedLiquidMetal
        {...resolvedMobileShaderProps}
        image={
          resolvedMobileShaderProps.image ??
          (defaultMobileShaderProps.image)
        } />
    </div>
  );
}
    ...
    <HeroLiquidMetalRoot {...props}>
      <HeroLiquidMetalContainer className={containerClassName}>
        <HeroLiquidMetalContent className={contentClassName}>
          <HeroLiquidMetalHeading className={headingWrapClassName} headingClassName={headingClassName} />
          <HeroLiquidMetalDescription
            className={descriptionWrapClassName}
            descriptionClassName={descriptionClassName} />
          <HeroLiquidMetalActions className={ctaWrapClassName} />
          <div
            className={cn("hidden lg:flex justify-center lg:justify-start", badgesWrapClassName)}
...
export function AISDKIcon(props) {
  return (
    <svg
      color="currentcolor"
